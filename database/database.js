...
var sethotchat = require('./set_hot_chat');
var sethotcategory = require('./set_hot_tag');
...
function createSchema(app, config) {
	...
	for (var i = 0; i < schemaLen; i++) {
        ...
        if(i==1) curSchema.plugin(autoIncrement.plugin, {model: 'ThreadModel_sj', field: 'thread_id'});
        else if(i==2) curSchema.plugin(autoIncrement.plugin, {model: 'MessageModel_sj', field: 'message_id'});
        else if(i==3) curSchema.plugin(autoIncrement.plugin, {model: 'CategoryModel_sj', field: 'category_id'});
        else if(i==7) curSchema.plugin(autoIncrement.plugin, {model: 'AdminModel_sj', field: 'admin_id'});
        else if(i==8) curSchema.plugin(autoIncrement.plugin, {model: 'NoticeModel_sj', field: 'notice_id'});
